        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ComputerName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Computer_Genre_GenreId",
                        column: x => x.GenreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cart_Computer_ComputerId",
                        column: x => x.ComputerId,
                        principalTable: "Computer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cart_ShoppingCart_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cart_ComputerId",
                table: "Cart",
                column: "ComputerId");

            migrationBuilder.CreateIndex(
                name: "IX_Cart_ShoppingCartId",
                table: "Cart",
                column: "ShoppingCartId");

            migrationBuilder.CreateIndex(
                name: "IX_Computer_GenreId",
                table: "Computer",
                column: "GenreId");
